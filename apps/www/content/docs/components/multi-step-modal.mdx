...
<TypeTable
  type={{
    ...
    details: {
      description:
        "Optional array of key-value rows shown in the details card.",
      type: "DetailRow[]",
      required: false,
    },
    onBack: {
      description:
        "Callback when the back chevron is clicked. Hidden if not provided.",
      type: "() => void",
      required: false,
    },
    onClose: {
      description:
        "Callback when the close button is clicked. Hidden if not provided.",
      type: "() => void",
      required: false,
    },
    className: {
