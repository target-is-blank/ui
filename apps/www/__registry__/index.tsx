...
export const index: Record<string, any> = {
  ...
  "ai-input": {
    ...
    type: "registry:ui",
    dependencies: ["motion","lucide-react","class-variance-authority","react-hook-form","zod","@hookform/resolvers"],
    devDependencies: undefined,
    registryDependencies: undefined,
    files: [
  {
  ...
  "date-picker": {
    name: "date-picker",
    description: "A smooth animated date picker with spring physics.",
    type: "registry:ui",
    dependencies: ["motion","date-fns","lucide-react","radix-ui"],
    devDependencies: undefined,
    registryDependencies: undefined,
    files: [
  {
    "path": "registry/components/date-picker/index.tsx",
    "type": "registry:ui",
    "target": "components/targetblank/components/date-picker.tsx",
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/components/date-picker/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "date-picker";
        const Comp = mod.default || mod[exportName];
    ...
    command: 'https://targetblank.dev/r/date-picker',
  },
  "date-range-timeline": {
    name: "date-range-timeline",
    description: "A smooth horizontal timeline scrubber for selecting date ranges.",
    type: "registry:ui",
    dependencies: ["motion","date-fns","lucide-react"],
    devDependencies: undefined,
    registryDependencies: undefined,
    files: [
  {
    "path": "registry/components/date-range-timeline/index.tsx",
    "type": "registry:ui",
    "target": "components/targetblank/components/date-range-timeline.tsx",
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/components/date-range-timeline/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "date-range-timeline";
        const Comp = mod.default || mod[exportName];
    ...
    command: 'https://targetblank.dev/r/date-range-timeline',
  },
  "loading-bar": {
    name: "loading-bar",
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/components/number-mosaic/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "number-mosaic";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/components/objective-bar/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "objective-bar";
        const Comp = mod.default || mod[exportName];
  ...
  "two-factor-setup": {
    ...
    description: "A dark-themed 2FA setup modal with animated QR scanner, backup code display, and OTP input.",
    ...
    files: [
  {
    "path": "registry/components/two-factor-setup/index.tsx",
    "type": "registry:component",
    "target": "",
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/components/two-factor-setup/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "two-factor-setup";
        const Comp = mod.default || mod[exportName];
    ...
    command: 'https://targetblank.dev/r/two-factor-setup',
  },
  "wheel-selector": {
    name: "wheel-selector",
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/components/wheel-selector/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "wheel-selector";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/animations/sparkles/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "sparkles-demo";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/animations/transfer/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "transfer-demo";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/backgrounds/particles/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "particles-background-demo";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    "content": "import CounterButton from \"@/components/targetblank/buttons/counter\";\n\nexport default function CounterDemo() {\n  return (\n    <CounterButton\n      durationSeconds={10}\n      onComplete={() => console.log(\"Completed!\")}\n      onClick={() => console.log(\"Clicked!\")}\n      acceleration\n      angleSpread={10}\n    />\n  );\n}"
  }
],
    keywords: [],
    component: (function() {
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/components/ai-input/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "ai-input-demo";
        const Comp = mod.default || mod[exportName];
  ...
  "date-picker-demo": {
    ...
    description: "A demo of the date picker component.",
    ...
    files: [
  {
    "path": "registry/demo/components/date-picker/index.tsx",
    "type": "registry:example",
    "target": "components/demo/date-picker-demo.tsx",
    "content": "\"use client\";\n\nimport { DatePickerInput } from \"@/components/targetblank/components/date-picker\";\nimport React from \"react\";\n\nexport default function DatePickerDemo() {\n  const [date, setDate] = React.useState<Date | undefined>(new Date());\n  return (\n    <div className=\"flex items-center justify-center min-h-[400px]\">\n      <DatePickerInput\n        value={date}\n        onChange={setDate}\n        placeholder=\"Pick a date\"\n      />\n    </div>\n  );\n}"
  }
],
    keywords: [],
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/components/date-picker/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "date-picker-demo";
        const Comp = mod.default || mod[exportName];
    ...
    command: 'https://targetblank.dev/r/date-picker-demo',
  },
  "date-range-timeline-demo": {
    name: "date-range-timeline-demo",
    description: "Demo of the date range timeline component.",
    type: "registry:example",
    dependencies: undefined,
    devDependencies: undefined,
    registryDependencies: ["date-range-timeline"],
    files: [
  {
    "path": "registry/demo/components/date-range-timeline/index.tsx",
    "type": "registry:example",
    "target": "components/demo/date-range-timeline-demo.tsx",
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/components/date-range-timeline/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "date-range-timeline-demo";
        const Comp = mod.default || mod[exportName];
    ...
    command: 'https://targetblank.dev/r/date-range-timeline-demo',
  },
  "loading-bar-demo": {
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/components/loading-bar/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "loading-bar-demo";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/components/number-mosaic/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "number-mosaic-demo";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/components/objective-bar/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "objective-bar-demo";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/components/signature/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "signature-demo";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/components/step-bar/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "step-bar-demo";
        const Comp = mod.default || mod[exportName];
  ...
  "two-factor-setup-demo": {
    ...
    dependencies: undefined,
    devDependencies: undefined,
    registryDependencies: ["two-factor-setup"],
    files: [
  {
    "path": "registry/demo/components/two-factor-setup/index.tsx",
    "type": "registry:example",
    "target": "",
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/components/two-factor-setup/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "two-factor-setup-demo";
        const Comp = mod.default || mod[exportName];
    ...
    command: 'https://targetblank.dev/r/two-factor-setup-demo',
  },
  "wheel-selector-demo": {
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/components/wheel-selector/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "wheel-selector-demo";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/hooks/use-debounce/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "use-debounce-demo";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/hooks/use-online-status/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "use-online-status-demo";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/hooks/use-scroll-position/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "use-scroll-position-demo";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/demo/hooks/use-undo-redo/index.tsx");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "use-undo-redo-demo";
        const Comp = mod.default || mod[exportName];
    ...
    files: [
  {
    ...
    component: (function() {
      const LazyComp = React.lazy(async () => {
        const mod = await import("@/registry/hooks/use-scroll-position/index.ts");
        const exportName = Object.keys(mod).find(
          key => typeof mod[key] === 'function' || typeof mod[key] === 'object'
        ) || "use-scroll-position-hook";
        const Comp = mod.default || mod[exportName];
